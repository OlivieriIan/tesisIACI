...
De estas 2 librerías se obtiene el diagrama de módulos presentado en la figura \ref{fig:2.3}, el cual muestra cómo se relacionan todos los módulos descriptos anteriormente. 
