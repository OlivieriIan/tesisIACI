...
\includegraphics[width=\textwidth]{resources/0-UNQlogo.jpg}\\[1.5cm] %University logo
...
\begin{flushleft} \large
\textsc{\large Director: Pernia, Eric}\\[1cm] % Authors
\textsc{\large Autor: Olivieri, Ian Paulo}\\[2cm] % Authors
\end{flushleft}
%\rule{\linewidth}{0.1mm} %Separation line
\begin{flushright} \large
\textsc{\large 10 de Septiembre, 2017}\\[0.5cm] %date
\end{flushright} 
