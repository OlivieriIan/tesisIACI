...
Por este motivo, Blackout se vió en la necesidad de buscar a alguien externo a la empresa para darle fin al proyecto, lo que presentó la oportunidad de realizar el trabajo de programación y finalización del equipo. Este desarrollo dió origen entonces al presente trabajo final.
...
\subsection{REQ-04}
Concluir el desarrollo del DIP-switch.
