...
\textcolor{FIXME}{Arreglá lineas (ALT + flechas en openoffice) y colores (quizas) del gráfico}
...
Su función es seleccionar el canal inicial de DMX con el que el equipo trabajará. Cuenta con 10 switchs: 9 para la selección del canal (0 a 512) y uno para futuras ampliaciones. \\
Esta pieza es una de las que está pendiente a desarrollo.
...
\begin{itemize}
	...
	%\item Canal de debug (Software UART)
\end{itemize}
...
Es entonces que se presentó la oportunidad de realizar el trabajo de concluir el desarrollo del equipo, que es en lo que este proyecto final se basa.
