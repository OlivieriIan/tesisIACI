...
En la sección \ref{sec:3.4} se determinaron los valores de resistencias que se utilizarán. Ahora, cada combinación posible de estos valores de resistencia R1,R2,R3 y R4 tiene una salida analógica diferente. Como la idea es obtener la combinación a partir del valor analógico de salida lo primero es determinar la equivalencia entre ambas.\\
